...
.semi-transparent(v-show="thanksDisplay")
  .thanks
    ...
    ul.thanks__list
      li
        a(href="https://challenge.thef2e.com/user/1600?schedule=3851#works-3851" target="_blank") UI 設計師 edith.hsu 的 UI 稿，並提供相關 icon 圖檔
      li
        a(href="https://challenge.thef2e.com/news/17" target="_blank") 六角學院提供旅館 API 服務
      li
...
.btn-thanks
  ...
  text-shadow: 1px 1px 4px $dark-grey
  overflow: hidden
  @include tablet()
    top: 10px
    bottom: initial
  ...
  &::before
    animation: aniCircle 5s ease-in-out infinite
@keyframes aniCircle
  0%
